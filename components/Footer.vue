<template>
      <footer id="footer" class="relative  ">
        <div class="py-6 max-w-6xl mx-auto px-6">
          <div class="mb-3">
            <div class="text-1100 flex flex-col md:flex-row md:items-center">
              <span class="text-xl font-semibold text-3xl md:text-6xl">Reach out to me on</span>
              <a 
                class="md:ml-6 border-1100 w-12 h-12 rounded-full p-2 border-2" href="mailto:meprabingrg@gmail.com">
                <svg 
                  xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" 
                  class="h-auto w-auto  hover:opacity-50 "><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
              </a>
            </div>
          </div>
