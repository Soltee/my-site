<template>
    ...
    <main id="main" class="main">
		...
		<div class="py-6 mt-12 px-6 max-w-6xl mx-auto">
			<vue-simplebar>
				<div class="pb-8">
		            <div class="skills flex flex-row justify-center items-center">
		                ...
		                <div class="skill-div px-6 py-0 rounded-full border-1200">
		                    <div class="flex flex-col items-center">
		                        <img class="h-16 w-16 text-red-600 object-cover object-center"    src="~/assets/img/inertiajs.png"  alt="@inertiajs">
		                    </div>
		                </div>

		                <div class="skill-div px-6 py-0 rounded-full border-1200">
		                    <div class="flex flex-col items-center">
		                        <img class="h-16 w-16 text-red-600 object-cover object-center" src="~/assets/img/livewire.png"  alt="livewire">
		                    </div>
		                </div>
