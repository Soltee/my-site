<template>
	<div class="">
		    ...
		    <div class="w-full flex flex-col md:flex-row md:items-center max-w-6xl px-6 w-full mx-auto">
		      	<div class="flex flex-col items-start pb-6 lg:pb-0">
		          	...
		          	<div class="mt-5 md:mt-10 flex flex-col md:flex-row">
		              	...
		              	<a v-smooth-scroll href="#projects" class=" px-6 py-3 lg:mr-auto w-56 font-bold  text-lg capitalize tracking-wide shadow-lg text-center text-white rounded-lg bg-1100 text-white hover:opacity-80">
		                	Check My Works
		              	</a>

		             	<a href="resume.pdf" class="mt-4 md:mt-0 md:ml-5 px-6 py-3 lg:mr-auto w-56 font-bold text-center text-lg tracking-wide rounded-lg border border-1100 shadow  hover:border-0 hover:bg-1100 text-1100 hover:text-white" target="_blank">
		                  	Download Resume
		              	</a>
		      	...
		      	<div class="hidden lg:block">
		          	<img class="max-w-lg object-center object-cover rounded" data-src="/img/fade_me.png" alt="hero-banner" v-lazy-load>
		      	</div>
		  	</div>
	  	</div>
	    ...
	    <main id="main" class="main">
	    	...
	    	<!-- Projects -->
	        <section id="projects"  class="relative my-12 md:my-24">
	          
	          	<div class="py-6 px-6 max-w-6xl mx-auto flex flex-col">
	          		<div id="" class="w-full ">
	              		<h1 class="font-bold text-1100 text-4xl md:text-6xl tracking-wide">Projects I'm Proud Of</h1>
	              	</div>

	              	<div                     	
						class="w-full mt-4  md:masonry-2-col lg:masonry-3-col box-border mx-auto before:box-inherit after:box-inherit">
	                    	...
	                    	class="w-full mb-8 break-inside">
	              			<div class="shadow-lg rounded-lg px-6 py-8">
	                        	...
	                        	<a 
	                        		...
	                        		@click="showProject(project)"
	                        		target="_blank">
		                        	<h3 class="mt-2 text-xl  font-semibold  hover:opacity-75 text-1100 text-center hover:bg-opacity-70 cursor-pointer">
		                        		{{ project.name }}
		                        	</h3>
		                        </a>
	        ...
	        <!-- Skills & Technology -->
	        <section id="skills"  class="relative my-12 md:my-24 bg-gradient-to-b ">
				<div class="py-6 px-6 max-w-6xl mx-auto">
					<div id="" class="w-full ">
	              		<h1 class="font-bold text-1100 text-3xl md:text-6xl tracking-wide">
	              			My Technology Stack
	              		</h1>
	              	</div>
					<no-ssr>
					 	<vue-tiny-slider v-bind="tinySliderOptions">
					       	<div class=" px-6 py-0 rounded-full border-1200">
				                ...
				                <div class=" px-6 py-0 rounded-full border-1200">
				                    <div class="flex flex-col items-center">
				                    	<img class="w-16 h-16 rounded-lg" src="/img/nuxt.png" alt="">
				                        
				                    </div>
				                </div>
				                <div 
				                	class=" py-0 rounded-full border-1200">
				                    <div class="flex flex-col items-center">
				                		<img class="w-12 h-12 rounded-lg" :src="`https://avatars.githubusercontent.com/u/47703742?s=200&v=4`" alt="">
				                	</div>
				                </div>
					    </vue-tiny-slider>
					</no-ssr>
	        ...
	        <transition>
		        <div 
		        	v-if="projectModalStatus">
		        		<Project
		        			@changeProjectModalStatus="closeProjectModal"
  	...
  	export default {
  		...
  		data(){
  			return {
  				tinySliderOptions: {
			        ...
			        controlsText : [
			        		'<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-left-circle h-8 w-8 mx-2 text-1100"><circle cx="12" cy="12" r="10"></circle><polyline points="12 8 8 12 12 16"></polyline><line x1="16" y1="12" x2="8" y2="12"></line></svg>',
			        		'<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-right-circle h-8 w-8 mx-2 text-1100"><circle cx="12" cy="12" r="10"></circle><polyline points="12 16 16 12 12 8"></polyline><line x1="8" y1="12" x2="16" y2="12"></line></svg>'
			        	],
			        responsive : {
			        	1: {
			        		gutter:10,
	  	...
	  	methods: {
	  		showProject(project){
	  			...
	  			this.projectModalStatus = true;
	  		},
	  		closeProjectModal(){
	  			this.projectModalStatus = !this.projectModalStatus
